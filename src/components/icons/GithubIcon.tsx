/**
 * GithubIcon - small inline SVG for the GitHub logo.
 * Not available in lucide-react (brand icons were removed in v1.0),
 * so it's hand-written here, sized/colored the same way as lucide icons
 * (accepts className, uses currentColor)
 */
